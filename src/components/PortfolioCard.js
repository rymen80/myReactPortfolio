                  ...
                  <Card className={classes.root}>
                    ...
                    <CardActions>
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            "https://tuanasaurus.github.io/groupProject1DinnerMovie/"
                          )
                        }
                      >
                        Check It Out
                      ...
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            "https://github.com/tuanasaurus/groupProject1DinnerMovie.git"
                          )
                        }
                      >
                        code
                  ...
                  <Card className={classes.root}>
                    ...
                    <CardActions>
                      ...
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            "https://github.com/rymen80/issueManager.git",
                            "_blank"
                          )
                        }
                      >
                  ...
                  <Card className={classes.root}>
                    ...
                    <CardActions>
                      ...
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            "https://github.com/rpdurk/TheIronDojo-Mongo-.git"
                          )
                        }
                      >
                        code
